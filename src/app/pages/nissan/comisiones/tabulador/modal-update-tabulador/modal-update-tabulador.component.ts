...
@Component({
  selector: 'app-modal-update-tabulador',
  templateUrl: './modal-update-tabulador.component.html',
  styleUrl: './modal-update-tabulador.component.css'
})
export class ModalUpdateTabuladorComponent implements AfterViewInit {
  ...
  public save() {
    ...
    this.tabuladorService.update( this.datos.id, payload).subscribe((response:any)=>{

...
@Component({
  selector: 'app-form-table-entradas',
  templateUrl: './form-table-entradas.component.html',
  styleUrl: './form-table-entradas.component.css'
})
export class FormTableEntradasComponent implements OnInit {
    ...
    detalles.forEach((detalle, index) => {
      const detalleGroup = this.fb.group({
        ...
        recibidos: ['', [
          Validators.required,
          Validators.min(0.01),
          Validators.max(detalle.cantidad)
        ]],
        comentario: ['', []]
      });
